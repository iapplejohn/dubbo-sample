...
import com.jemmy.dubbo.sample.common.exception.ConfigurationException;
import com.jemmy.dubbo.sample.common.util.Constants;
import com.jemmy.dubbo.sample.registry.config.GovernanceConfiguration;
import com.jemmy.dubbo.sample.registry.metadata.MetaDataCollector;
import com.jemmy.dubbo.sample.registry.metadata.impl.NoOpMetadataCollector;
...
public class ConfigCenter {
    ...
    @Value("${gateway.config-center:}")
    private String configCenter;

    @Value("${gateway.registry.address:}")
    private String registryAddress;

    @Value("${gateway.metadata-report.address:}")
    private String metadataAddress;

    @Value("${gateway.registry.group:}")
    private String group;

    @Value("${gateway.config-center.username:}")
    private String username;
    @Value("${gateway.config-center.password:}")
